...
pub struct FlowchartApp {
    ...
    pub(crate) show_spec_paste_area: bool,
    pub(crate) spec_paste_buf: String,
    ...
    /// The NodeId currently under the cursor (set each frame by canvas.rs).
    /// Used by statusbar to show hovered node info.
...
impl FlowchartApp {
    pub fn new(cc: &eframe::CreationContext<'_>) -> Self {
        ...
        Self {
            ...
            show_spec_paste_area: false,
            spec_paste_buf: String::new(),
