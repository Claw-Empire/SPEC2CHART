...
pub struct NodeStyle {
    ...
    #[serde(default)]
    pub gradient: bool,
    /// Gradient angle in degrees: 0=top→bottom, 90=left→right, 45=↘ diagonal, 135=↗ diagonal
    #[serde(default)]
    pub gradient_angle: u8,
    ...
    /// When true, render a neon glow ring around the node border
    #[serde(default)]
    pub glow: bool,
}
...
pub struct Node {
    ...
    /// Optional icon/emoji badge shown in node top-left corner
    #[serde(default)]
    pub icon: String,
    ...
    /// Section name — populated from the `## Section Header` that contained this node.
    ...
    /// Support ticket priority (0 = unset, 1 = P1, 2 = P2, 3 = P3, 4 = P4).
    /// Set via `{p1}`/`{p2}`/`{p3}`/`{p4}` HRF tags; rendered as "P1" pill on canvas.
    #[serde(default)]
    pub priority: u8,
}
...
impl Node {
    ...
    pub fn new_sticky(color: StickyColor, position: Pos2) -> Self {
        Self {
            ...
            style: NodeStyle {
                ...
                font_size: 14.0,
                corner_radius: 8.0, border_dashed: false, gradient: false, gradient_angle: 0, opacity: 1.0, shadow: false, bold: false, italic: false, text_align: TextAlign::Center, text_valign: TextVAlign::Middle, glow: false,
            },
        }
    }
    ...
    pub fn new_entity(position: Pos2) -> Self {
        Self {
            ...
            style: NodeStyle {
                ...
                text_color: [205, 214, 244, 255],
                font_size: 12.0,
                corner_radius: 4.0, border_dashed: false, gradient: false, gradient_angle: 0, opacity: 1.0, shadow: false, bold: false, italic: false, text_align: TextAlign::Center, text_valign: TextVAlign::Middle, glow: false,
            },
        }
    }
    ...
    pub fn new_text(position: Pos2) -> Self {
        Self {
            ...
            style: NodeStyle {
                ...
                text_color: [205, 214, 244, 255],
                font_size: 16.0,
                corner_radius: 0.0, border_dashed: false, gradient: false, gradient_angle: 0, opacity: 1.0, shadow: false, bold: false, italic: false, text_align: TextAlign::Center, text_valign: TextVAlign::Middle, glow: false,
            },
        }
    }
    ...
    pub fn new_frame(position: Pos2) -> Self {
        Self {
            ...
            locked: false,
            comment: String::new(),
            frame_color: default_frame_color(), icon: String::new(), sublabel: String::new(), depth_3d: 0.0, highlight: false, progress: 0.0, timeline_period: None, timeline_lane: None, section_name: String::new(), created_date: String::new(), priority: 0,
