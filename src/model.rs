...
impl Node {
    ...
    pub fn new(shape: NodeShape, position: Pos2) -> Self {
        ...
        Self {
            ...
            size,
            z_offset: 0.0, pinned: false, tag: None, collapsed: false, uncollapsed_size: None, url: String::new(), locked: false, comment: String::new(), is_frame: false, frame_color: default_frame_color(), icon: String::new(),
    ...
    pub fn new_sticky(color: StickyColor, position: Pos2) -> Self {
        Self {
            ...
            style: NodeStyle {
                ...
                font_size: 14.0,
                corner_radius: 8.0, border_dashed: false, gradient: false, gradient_angle: 0, opacity: 1.0, shadow: false, bold: false, italic: false, text_align: TextAlign::Center, text_valign: TextVAlign::Middle,
            },
        }
    }
    ...
    pub fn new_entity(position: Pos2) -> Self {
        Self {
            ...
            style: NodeStyle {
                ...
                text_color: [205, 214, 244, 255],
                font_size: 12.0,
                corner_radius: 4.0, border_dashed: false, gradient: false, gradient_angle: 0, opacity: 1.0, shadow: false, bold: false, italic: false, text_align: TextAlign::Center, text_valign: TextVAlign::Middle,
            },
        }
    }
    ...
    pub fn new_text(position: Pos2) -> Self {
        Self {
            ...
            style: NodeStyle {
                ...
                text_color: [205, 214, 244, 255],
                font_size: 16.0,
                corner_radius: 0.0, border_dashed: false, gradient: false, gradient_angle: 0, opacity: 1.0, shadow: false, bold: false, italic: false, text_align: TextAlign::Center, text_valign: TextVAlign::Middle,
            },
        }
    }
    ...
    pub fn new_frame(position: Pos2) -> Self {
        Self {
            ...
            locked: false,
            comment: String::new(),
            frame_color: default_frame_color(), icon: String::new(),
